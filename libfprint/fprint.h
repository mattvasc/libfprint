...
int fp_dscv_print_get_finger(struct fp_dscv_print *print) LIBFPRINT_DEPRECATED;
...
/* Data handling */
int fp_print_data_load(struct fp_dev *dev, int finger_id, struct fp_print_data **data);
